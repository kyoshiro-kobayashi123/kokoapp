...
subject.create(subject_name: RubyⅠ・Java・, color: white) #8
...
#二年生後期（Rubyコース）
timetable_entrie.cerate(class_id: 2, period_id: 1, subject_id: 20, wday: 月)
timetable_entrie.cerate(class_id: 2, period_id: 2, subject_id: 20, wday: 月)
timetable_entrie.cerate(class_id: 2, period_id: 3, subject_id: 19, wday: 月)
timetable_entrie.cerate(class_id: 2, period_id: 1, subject_id: 23, wday: 火)
timetable_entrie.cerate(class_id: 2, period_id: 2, subject_id: 23, wday: 火)
timetable_entrie.cerate(class_id: 2, period_id: 3, subject_id: 18, wday: 火)
timetable_entrie.cerate(class_id: 2, period_id: 1, subject_id: 18, wday: 水)
timetable_entrie.cerate(class_id: 2, period_id: 2, subject_id: 21, wday: 水)
timetable_entrie.cerate(class_id: 2, period_id: 3, subject_id: 21, wday: 水)
timetable_entrie.cerate(class_id: 2, period_id: 1, subject_id: 22, wday: 木)
timetable_entrie.cerate(class_id: 2, period_id: 2, subject_id: 22, wday: 木)
timetable_entrie.cerate(class_id: 2, period_id: 3, subject_id: 23, wday: 木)
timetable_entrie.cerate(class_id: 2, period_id: 1, subject_id: 24, wday: 金)
timetable_entrie.cerate(class_id: 2, period_id: 2, subject_id: 24, wday: 金)
